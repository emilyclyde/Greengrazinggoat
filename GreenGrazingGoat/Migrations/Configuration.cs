namespace GreenGrazingGoat.Migrations
{
  ...
  internal sealed class Configuration : DbMigrationsConfiguration<GreenGrazingGoat.DAL.GreenContext>
  {
    ...
    protected override void Seed(GreenGrazingGoat.DAL.GreenContext context)
    {
      ...
      var lots = new List<Lot>
            ...
            new Lot{LotID= 4, GoatID=4, CustomerID=4, CustomerFirst="Leo", CustomerLast="Lion",GoatName="Gytis", LotAddress="100 South Ave", LotDescription= "Level"}
            };
